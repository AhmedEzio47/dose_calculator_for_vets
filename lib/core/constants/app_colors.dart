...
class AppColors {
  ...
  static const darkBackground = Color(0xff222e3f);
  static const darkDivider = Color(0xff999999);
  static const darkCard = Color(0xff384352);
  static const darkBottomNavBar = Color(0xff384352);
